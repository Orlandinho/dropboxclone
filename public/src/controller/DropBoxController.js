class DropBoxController {
    ...
    connectFireBase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyBRSfIPfepiYaoss4XxSi8txkxWdrmZlcg",
            authDomain: "dropbox-clone-3bd4f.firebaseapp.com",
            databaseURL: "https://dropbox-clone-3bd4f-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-3bd4f",
            storageBucket: "dropbox-clone-3bd4f.appspot.com",
            messagingSenderId: "86623081918",
            appId: "1:86623081918:web:e678f2953cac9e269455ef",
            measurementId: "G-P3L48PX9G3"
          };
          // Initialize Firebase
        ...
        return new Promise((resolve, reject) => {
            ...
            folderRef.on('value', snapshot => {
                ...
                if (snapshot.exists()) {
                    ...
                    this.getFirebaseRef('Principal').child(key).remove();
